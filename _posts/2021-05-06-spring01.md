...
<img src="/Users/corner/Library/Application Support/typora-user-images/스크린샷 2021-05-06 오전 11.21.56.png" alt="스크린샷 2021-05-06 오전 11.21.56" style="zoom: 33%;" />
...
Lombok(롬복)을 이용하면 Java 개발 시 getter/setter, toString(),  생성자 등을 자동으로 생성해주므로 설치가 필요한 라이브러리 입니다.
...
jar 파일이 있는 경로에서 (Mac은 상관없이 바로 jar경로에서 터미널로 실행 하면 됨. 이클립스로 안옮겨도된다.)
...
### <span style="color: red;">주의!! MAC은 /Users/corner/Eclipse.app/Contents/Eclipse/eclipse.ini 로 경로를 잡고 설치해야한다.</span>
...
<img src="/Users/corner/Library/Application Support/typora-user-images/스크린샷 2021-05-06 오후 1.29.21.png" alt="스크린샷 2021-05-06 오후 1.29.21" style="zoom:33%;" />
...
웹과 관련된 스프링 설정 파일 <span style="color: gray;">(Resources, View Resolver)</span>

​		`src/main/webapp/WEB-INF/spring/appServlet/servlet-context.xml`

스프링 설정 파일  <span style="color: gray;">(Bean, IoC 컨테이너)</span>

​		`src/main/webapp/WEB-INF/spring/root-context.xml`

Tomcat의 web.xml 파일  <span style="color: gray;">(Front Controller, DispatcherServlet)</span>
...
## <span style="color: red;"> * 의존성 주입 테스트</span>
...
<img src="/Users/corner/Library/Application Support/typora-user-images/스크린샷 2021-05-06 오후 2.12.13.png" alt="스크린샷 2021-05-06 오후 2.12.13" style="zoom:33%;" />
...
![image-20210506141554365](file:///Users/corner/Library/Application%20Support/typora-user-images/image-20210506141554365.png?lastModify=1620278187)

![image-20210506141607557](file:///Users/corner/Library/Application%20Support/typora-user-images/image-20210506141607557.png?lastModify=1620278187)

![image-20210506141627993](file:///Users/corner/Library/Application%20Support/typora-user-images/image-20210506141627993.png?lastModify=1620278187)
...
![image-20210506143133147](/Users/corner/Library/Application Support/typora-user-images/image-20210506143133147.png)
